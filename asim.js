      <a onclick="location.href='index.html';" class="label label-primary   fl" style="width:96%;padding:6px;border-radius:0px;text-align: left;">
							<img onclick="location.reload();" src="prv1.png" class="fl" style="margin: -6px 2px -5px -6px;width:25px;border-radius: 30px;border: 2px solid;">
							شات ومض الخليج للجوال
