$("<div class='fr borderg' style='padding:2px;background-color:white;float:left;margin-left:2px;</a></div>").insertAfter($(".loginstat"));$('.checkbox label')['html'](`<input id="stealth" type="checkbox" value="" maxlength="12"><i class="fa fa-eye-slash" aria-hidden="true">`);$('.nav-tabs')['addClass']('fl')['css']('width','100%');$(`<link rel="stylesheet" type="text/css" href="">
  <link href="https://raw.githack.com/hussienail/Hos2/master/Jaf.css" rel="stylesheet" type="text/css">
  <style>
